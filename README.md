...
```
## Python files
put the following code in a file knowmad.py, This file contains all important functions necessary to perform the deep learning tasks of Notes generation, Youtube video extraction and Chatbot interaction
``` bash
import getpass
import os
import io
...
Make another python file app.py to put your streamlit code:
```bash 
